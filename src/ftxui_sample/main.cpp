...
// configuration step. It creates a namespace called `MyGhostEscape`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", MyGhostEscape::cmake::project_name, MyGhostEscape::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", MyGhostEscape::cmake::project_version);
      return EXIT_SUCCESS;
    }
